...
module.exports = class Transaction extends EthereumJsTransaction {
  ...
  validateNonce(expectedNonce) {
    ...
    //console.log('Transaction.validateNonce : expectedNonce' + u.inspect(expectedNonce))
    let nonce;
    ...
    //console.log('Transaction.validateNonce : nonce' + u.inspect(nonce))
    return nonce.eq(expectedNonce);
  }
