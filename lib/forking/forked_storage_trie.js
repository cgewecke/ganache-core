...
const BaseTrie = require("merkle-patricia-tree").CheckpointTrie;
const checkpointInterface = BaseTrie;
const MerklePatriciaTree = require("merkle-patricia-tree").BaseTrie;
